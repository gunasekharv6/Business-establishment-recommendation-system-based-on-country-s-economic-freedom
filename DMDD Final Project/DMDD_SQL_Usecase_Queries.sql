...
DESC yellow.ppp_value;
INSERT INTO yellow.ppp_value VALUES("Boston","Indicate 1",20, 20);
INSERT INTO yellow.ppp_value VALUES("New York","Indicate 2",30, 22);
INSERT INTO yellow.ppp_value VALUES("Chicago","Indicate 3",40, 23);
INSERT INTO yellow.ppp_value VALUES("Japan","Indicate 4",50, 24);
INSERT INTO yellow.ppp_value VALUES("India","Indicate 5",60, 25);

###############################

#select `OVERALL RANK `,`COUNTRY NAME ` from yellow.economic_factors a cross apply string_split(a.text,N',' );

select * from yellow.economic_factors;
order by `COUNTRY NAME`  DESC;


select * from yellow.global_terrorism
